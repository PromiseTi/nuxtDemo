...
<template>
  <div>
    <div class="padd-tb-ba text-center">
      <h1>Apply to Become a Sonior</h1>
    </div>
    ...
    <div class="marlrAuto margin-bottom-qi ambCont">
      <client-only>
        ...
        >
          ...
          <h2 class="coloBls">Types of Sonior</h2>
          <el-form-item
            prop="soniorTypes"
          ...
          <el-form-item prop="experienceStrengths" id="taPos">
            <div class="padding-left-xs inlineBlock" slot="label">
              <div class="fontBlod fontSize-16">
                Your experience and strengths in the skills you choose
              </div>
              <div>
                Please briefly introduce yourself, and elaborate on your work
                experience and advantages as follows.
              </div>
            </div>
            <el-input
              type="textarea"
          ...
          <div class="margin-tb fontSize-14 colo999">
            After signing up, please use your email address to send a message to
            the staff so that you can get a reply after passing.
          </div>
          <div class="margin-tb fontSize-14 colo999">
            Note:The email content needs to include your information and works,
            and the email information needs to be consistent with the email
            address filled in for registration.(If you choose content, you can
            leave your blog account or article, the designer can attach the
            design work, and the technologic project can attach code works.）
          </div>
          <el-form-item>
  ...
  methods: {
    ...
    interface() {
      ...
      $.ajax({
        ...
        data: JSON.stringify({
          ...this.addForm,
          soniorTypes: this.addForm.soniorTypes.join(),
        }),
        success: (data) => {
          if (data.status === "ok") {
